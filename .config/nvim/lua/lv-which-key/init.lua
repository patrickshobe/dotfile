...
vim.api.nvim_set_keymap("n", "<Leader>fb", ":Telescope current_buffer_fizzy_find<CR>", { noremap = true, silent = true })
...
vim.api.nvim_set_keymap("n", "<Leader>b<TAB>", ":b#<CR>", { noremap = true, silent = true })
